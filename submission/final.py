...
# categorial variables labelEncoder
...
train_embed_card = pd.read_csv("../features/train.embed_card.csv")
test_embed_card = pd.read_csv("../features/test.embed_card.csv")
...
# 增加uid_D15特征
uid_D15_train = pd.read_csv("../features/train_target_encoding_D15_shift.csv")
uid_D15_test = pd.read_csv("../features/test_target_encoding_D15_shift.csv")
train = train.merge(uid_D15_train, on="TransactionID", how="left")
test = test.merge(uid_D15_test, on="TransactionID", how="left")

# 增加uid_D10特征
uid_D10_train = pd.read_csv("../features/train_target_encoding_D10_shift.csv")
uid_D10_test = pd.read_csv("../features/test_target_encoding_D10_shift.csv")
train = train.merge(uid_D10_train, on="TransactionID", how="left")
test = test.merge(uid_D10_test, on="TransactionID", how="left")

# 增加uid_D1特征
uid_D1_train = pd.read_csv("../features/train_target_encoding_D1_shift.csv")
uid_D1_test = pd.read_csv("../features/test_target_encoding_D1_shift.csv")
train = train.merge(uid_D1_train, on="TransactionID", how="left")
test = test.merge(uid_D1_test, on="TransactionID", how="left")

# 增加uid_D2特征
uid_D2_train = pd.read_csv("../features/train_target_encoding_D2_shift.csv")
uid_D2_test = pd.read_csv("../features/test_target_encoding_D2_shift.csv")
train = train.merge(uid_D2_train, on="TransactionID", how="left")
test = test.merge(uid_D2_test, on="TransactionID", how="left")

# 增加uid_D4特征
uid_D4_train = pd.read_csv("../features/train_target_encoding_D4_shift.csv")
uid_D4_test = pd.read_csv("../features/test_target_encoding_D4_shift.csv")
train = train.merge(uid_D4_train, on="TransactionID", how="left")
test = test.merge(uid_D4_test, on="TransactionID", how="left")

# ======pEmail特征===========
uid_D15_train_pEmail = pd.read_csv("../features/train_target_encoding_D15_pEmail.csv")
uid_D15_test_pEmail = pd.read_csv("../features/test_target_encoding_D15_pEmail.csv")
train = train.merge(uid_D15_train_pEmail, on="TransactionID", how="left")
test = test.merge(uid_D15_test_pEmail, on="TransactionID", how="left")

# 增加uid_D10特征
uid_D10_train_pEmail = pd.read_csv("../features/train_target_encoding_D10_pEmail.csv")
uid_D10_test_pEmail = pd.read_csv("../features/test_target_encoding_D10_pEmail.csv")
train = train.merge(uid_D10_train_pEmail, on="TransactionID", how="left")
test = test.merge(uid_D10_test_pEmail, on="TransactionID", how="left")
...
print("lgb model")
params = {'learning_rate':0.006883242363721497, bagging_fraction': 0.8554035310857978, 'feature_fraction': 0.5799210205193864,
